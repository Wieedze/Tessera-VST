# PAMPLEJUCE_CLAUDE.md — reference

> Copy of the `CLAUDE.md` shipped by the Pamplejuce template (sudara/pamplejuce, fetched 2026-05-11). Kept here for reference / cross-check against our own `CLAUDE.md` at the repo root. **Not auto-loaded by Claude Code.**
